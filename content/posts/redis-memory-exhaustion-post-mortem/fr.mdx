...
- **Compressé les Payloads** : Un collègue ([Guillaume Gautreau](https://www.ghusse.com/redis/node/compress/does-it-worth-compressing-large-json-in-redis/)) a pris le temps d'étudier et d'implémenter une solution de compression des données _avant_ leur stockage dans Redis. Non seulement cela a optimisé nos coûts de mémoire de manière significative, mais cela s'est également traduit par des temps de transport HTTPS plus rapides en raison de la taille réduite des payloads.
