...
import selfServiceAnalyticsDiagram from "../../../src/assets/images/posts/self-service-analytics-en.svg";
...
<figure className="post-visual">
  <img
    ...
    alt="Governed self-service analytics flow from a business question through certified marts or a reviewed modeling path."
  />
  <figcaption>
    Self-service analytics needs a governed read path and a reviewed route for missing models.
  </figcaption>
</figure>
