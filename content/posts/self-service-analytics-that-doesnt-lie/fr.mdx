...
summary: "L'architecture d'analytique en libre-service que nous voulons construire chez RockFi : des requêtes limitées aux marts gouvernés, des contrats de métriques explicites et des agents qui proposent les modèles manquants sans contourner les contrôles."
...
import selfServiceAnalyticsDiagram from "../../../src/assets/images/posts/self-service-analytics-fr.svg";

Chez RockFi, l'analytique en libre-service n'est pas une success story que je peux emballer dans un joli retour d'expérience. C'est un objectif que nous poursuivons activement — et que nous ne maîtrisons pas encore complètement.
...
## Des données disponibles ne sont pas forcément fiables
...
<figure className="post-visual">
  <img
    src={selfServiceAnalyticsDiagram}
    alt="Flux d'analytics self-service gouverné depuis une question métier vers des marts certifiés ou un parcours de modélisation revue."
  />
  <figcaption>
    Le self-service a besoin d'un chemin de lecture gouverné et d'une voie revue pour les modèles manquants.
  </figcaption>
</figure>
...
## À quoi sert réellement une couche sémantique

On décrit souvent une couche sémantique comme un moyen d'éviter de répéter du SQL. C'est utile, mais incomplet. Son rôle le plus important est de donner un sens métier partagé aux champs et aux mesures.
...
Cela ne rend pas la couche sémantique autoritaire par simple déclaration. Elle le devient lorsque ses définitions sont testées contre la réalité opérationnelle et que les changements ont un owner et une date d'effet.
