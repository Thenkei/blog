...
- Part 2 - [Jobify + BullMQ + worker/queue contracts in NestJS](../jobify-workers-queues-nestjs/en.mdx)
- Part 3 - [idempotency + debounce hardening (reschedule vs time-frame)](../idempotency-debounce-jobify-bullmq/en.mdx)
...
- Continue with architecture and worker contracts in [Part 2](../jobify-workers-queues-nestjs/en.mdx).
- Then harden dedupe and trigger storms in [Part 3](../idempotency-debounce-jobify-bullmq/en.mdx).
