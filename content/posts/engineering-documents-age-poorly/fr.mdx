...
subtitle: "Un document reste utile lorsque sa décision, son owner, ses preuves et ses conditions d'expiration sont explicites."
...
import documentLifecycleDiagram from "../../../src/assets/images/posts/document-lifecycle-fr.svg";
...
<figure className="post-visual">
  <img
    src={documentLifecycleDiagram}
    alt="Cycle de vie d'un document : décision ou observation, publication, implémentation, changement du système, contrôle de fraîcheur, mise à jour ou archivage."
  />
  <figcaption>
    Un document reste utile lorsque son cycle de vie et ses conditions de sortie sont visibles.
  </figcaption>
</figure>
...
## Une documentation générée n'est pas automatiquement à jour (désolé, les robots)
...
L'expiration n'est pas la destruction. Archivez un document avec son statut, sa date et sa raison. Pointez vers le remplacement lorsqu'il existe. Préservez les décisions historiques lorsqu'elles expliquent le chemin vers le présent, mais retirez-les du parcours par défaut de la personne qui opère le système aujourd'hui.
...
Le meilleur moment pour revoir la documentation est celui où le système change, pas celui où un audit annuel apparaît dans le calendrier.
...
Enfin, la fraîcheur n'est pas la vérité. Un document peut avoir été revu hier et décrire quand même une mauvaise décision. La revue confirme son alignement avec le système courant ; elle ne remplace pas le jugement d'ingénierie.
