...
## Un document possède un cycle de vie, qu'on le gère ou non
...
Dire aux équipes de « garder la doc à jour » ne traite aucune de ces conditions. Le système a besoin d'un contrat plus petit et plus explicite.
...
## Une documentation générée n'est pas automatiquement actuelle
