...
## A document has a lifecycle whether you manage it or not
...
Telling teams to “keep docs up to date” does not address these conditions. The system needs a smaller, more explicit contract.
...
## Generated documentation is not automatically current
