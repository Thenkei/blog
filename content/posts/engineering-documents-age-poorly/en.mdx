...
import documentLifecycleDiagram from "../../../src/assets/images/posts/document-lifecycle-en.svg";
...
<figure className="post-visual">
  <img
    ...
    alt="Document lifecycle showing a decision or observation moving through publication, implementation, system change, and a freshness check before update or archive."
  />
  <figcaption>
    A document remains useful when its lifecycle and exit conditions are visible.
  </figcaption>
</figure>
